...
const AboutPage = () => {
  ...
  const aiTechStack = [
    ...
    {
      name: "Hugging Face",
      src: "https://cdn.simpleicons.org/huggingface/ffcc66",
    },
    { name: "NVIDIA", src: "https://cdn.simpleicons.org/nvidia/76b900" },
    {
      name: "LangChain",
      src: "https://static.cdnlogo.com/logos/l/8/langchain_800.png",
    },
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-xl md:text-2xl text-secondary-silver mb-8 max-w-2xl">
                We&apos;re on a mission to make advanced AI solutions accessible
                to businesses of all sizes, driving innovation and growth
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              {[
                ...
                },
                {
                  ...
                  label: "Technology",
                  description:
                    "Built on the most advanced AI frameworks available.",
                },
              ].map((stat, index) => (
                <div
                  key={index}
              ...
              <div>
                ...
                <div className="space-y-6 text-lg text-secondary-silver">
                  ...
                  <p>
                    ...
                    address complex business challenges across industries. Moving
                    forward, we aim to lead the next wave of AI innovation,
                    empowering organizations around the world to unlock the
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
              <div className="bg-secondary-charcoal/30 backdrop-blur-sm rounded-xl p-8 border border-secondary-silver/10 hover:border-accent/30 transition-all">
                ...
                <p className="text-lg text-secondary-silver">
                  Our mission is to pioneer innovative solutions that shape the
                  future of business and technology. Through relentless pursuit of
                  excellence and cutting-edge thinking, we strive to empower
                  businesses to leverage technology for growth, AI for efficiency,
                  and long-term success. We believe in creating meaningful,
                  sustainable impact through collaboration and forward-thinking
                  solutions.
                </p>
              </div>
              <div className="bg-secondary-charcoal/30 backdrop-blur-sm rounded-xl p-8 border border-secondary-silver/10 hover:border-accent/30 transition-all">
                ...
                <p className="text-lg text-secondary-silver">
                  Our vision is to be the global leader in technology innovation,
                  revolutionizing industries by transforming ideas into action. We
                  aim to create a future-ready world where technology works
                  seamlessly to solve the world&apos;s most pressing challenges
                  while delivering unparalleled value to businesses and
