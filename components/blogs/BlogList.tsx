...
interface BlogListProps {
    initialBlogs: Blog[];
    initialCategories: { name: string; subcategories: string[] }[];
}

const BlogList = ({ initialBlogs, initialCategories }: BlogListProps) => {
    ...
    const availableSubcategories =
        selectedCategory === "All"
            ...
            : [
                "All",
                ...(initialCategories.find((cat) => cat.name === selectedCategory)
                    ?.subcategories || []),
            ];
