...
const ServicesIndustries: React.FC<{ industries: IndustriesSection }> = ({
  industries,
}) => {
  return (
          ...
          {[
            {
              ...
              title: "Healthcare",
              description:
                "AI-powered diagnostic tools, patient data analytics, and healthcare operations optimization.",
              image:
            ...
            },
            {
              ...
              title: "Finance",
              description:
                "Fraud detection systems, algorithmic trading platforms, and customer service automation.",
              image:
            ...
            },
            {
              ...
              image:
                "https://images.unsplash.com/photo-1581092921461-eab10d86d6e1?q=80&w=800&auto=format&fit=crop",
            },
            {
              icon: <ShieldIcon size={32} className="text-accent" />,
              title: "Cybersecurity",
              description:
                "Threat detection systems, security analytics, and automated incident response.",
              image:
            ...
            },
            {
              ...
              title: "Retail",
              description:
                "Personalized recommendation engines, inventory management, and customer analytics.",
              image:
            ...
            },
            {
              ...
              title: "Energy",
              description:
                "Grid optimization, consumption forecasting, and renewable energy management.",
              image:
            ...
            >
              ...
              <div className="relative p-6 h-full flex flex-col justify-end min-h-[250px]">
                ...
                <p className="text-secondary-silver">{industry.description}</p>
